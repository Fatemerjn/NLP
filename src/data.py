...
def load_dataset(
    ...
    # Resolve path (supports running from repo root or elsewhere)
    ...
    use_stratify = True
    # Need >=2 per class to stratify reliably
    if min_per_class < 2:
        use_stratify = False
        print("[data] Not stratifying: at least one class has < 2 samples.")
    # Need at least one instance of each class in the test set
